...
var _generatorStyles = require('./formatters/styles/generatorStyles');

var _generatorStyles2 = _interopRequireDefault(_generatorStyles);
...
var generateXMLWorksheet = exports.generateXMLWorksheet = function generateXMLWorksheet(rows, styles) {
  var styleBlock = (0, _generatorStyles2.default)(styles);
  var XMLRows = (0, _generatorRows2.default)(rows);
  return _worksheet2.default.replace('{stylesPlaceholder}', styleBlock).replace('{placeholder}', XMLRows);
};
...
exports.default = function (config) {
  ...
  var worksheet = generateXMLWorksheet(config.sheet.data, config.styles);
