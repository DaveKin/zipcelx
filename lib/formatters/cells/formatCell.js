...
var styleProp = function styleProp(stylename) {
  var styleId = 2;
...
exports.default = function (cell, index, rowIndex) {
  ...
  return cell.type === _constants.CELL_TYPE_STRING ? (0, _generatorStringCell2.default)(index, cell.value, rowIndex, styleProp(cell.style)) : (0, _generatorNumberCell2.default)(index, cell.value, rowIndex, styleProp(cell.style));
};